        ...
        <section class="hero-section text-white py-32">
            <div class="container mx-auto px-4 text-center">
                ...
                <p class="text-xl mb-8 max-w-2xl mx-auto">
                    Reservasi meja lebih mudah di Ikan Bakar Cianjur Batu Tulis. 
                    Pesan tempat saja atau sekaligus pilih menu favorit Anda!
                </p>
                <div class="flex flex-col sm:flex-row justify-center gap-4">
                    <a href="/login" class="gold-bg text-white px-8 py-3 rounded-md font-medium hover:bg-opacity-90">
                        LOGIN UNTUK RESERVASI
                    </a>
                    <a href="/register" class="gold-bg text-white px-8 py-3 rounded-md font-medium hover:bg-opacity-90">
