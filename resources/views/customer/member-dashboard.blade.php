...
<div class="container mx-auto px-4 -mt-10">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        ...
        <!-- Poin Member -->
        <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 gold-border">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-gray-500 text-sm font-medium">Poin Member</p>
                    <h3 class="text-3xl font-bold text-gray-800 mt-2">{{ $memberPoints ?? 0 }}</h3>
                    <p class="text-xs text-gray-400 mt-1">🎁 Tukar dengan promo menarik</p>
                </div>
                <div class="gold-bg p-4 rounded-full">
